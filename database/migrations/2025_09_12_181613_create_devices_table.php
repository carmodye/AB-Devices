...
class CreateDevicesTable extends Migration
{
    public function up()
    {
        Schema::create('devices', function (Blueprint $table) {
            ...
            $table->string('macAddress')->nullable()->index(); // e.g., "00A15923FB78", indexed for searching
            ...
            $table->bigInteger('unixepoch')->nullable()->index(); // e.g., 1756551122034, indexed for sorting
            $table->timestamps();
        });
    }
